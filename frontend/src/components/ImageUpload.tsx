...
const ImageUpload = forwardRef<ImageUploadHandle, Props>(
  function ImageUpload({ selectedFile, previewUrl, disabled, hairlineYRatio, onHairlineChange, onFileChange }: Props, ref) {
